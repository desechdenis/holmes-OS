...
_SETTINGS_FIELD_MAP: dict[str, str] = {
    ...
    "HOME_ASSISTANT_MODE_ENTITY": "home_assistant_mode_entity",
    "HOME_ASSISTANT_PRESENCE_ENTITIES": "home_assistant_presence_entities",
    "HOME_ASSISTANT_WEATHER_ENTITY": "home_assistant_weather_entity",
    "HOME_ASSISTANT_CALENDAR_ENTITIES": "home_assistant_calendar_entities",
